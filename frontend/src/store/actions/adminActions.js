...
export const approveUser = (uuid) => {
    return async dispatch => {
        const url = `http://87823f79f571.ngrok.io/myapp/admin/user/${uuid}/approve`
...
export const declineUser = (uuid) => {
    return async dispatch => {
        const url = `http://87823f79f571.ngrok.io/myapp/admin/user/${uuid}/deny`
...
export const allowTokenIssue = (uuid, name) => {
    return async dispatch => {
        const url = `http://87823f79f571.ngrok.io/myapp/tokens/issued_tokens/${uuid}/${name}/accept`
...
export const getRegistrationRequests = () => {
    return async dispatch => {
        const url = `http://87823f79f571.ngrok.io/myapp/admin/user/pending/list`
...
export const getTokenApproveRequests = () => {
    return async dispatch => {
        const url = `http://87823f79f571.ngrok.io/myapp/tokens/issued_tokens/pending`
...
export const blockUser = (uuid) => {
    return async dispatch => {
        const url = `http://87823f79f571.ngrok.io/myapp/ban_user/${uuid}`
